...
void SketchPalette::applyStyleSheet()
{
    setStyleSheet(
        ...
        "  border-radius: 6px;"
        "}"
        "#SketchPalette QLabel {"
        "  color: #cccccc;"
        "  font-size: 11px;"
        "  background: transparent;"
        "}"
        "#SketchPalette #paletteTitle {"
        "  color: #ffffff;"
        "  font-size: 12px;"
        "  font-weight: bold;"
        "  background: transparent;"
        "}"
        "#SketchPalette #sectionHeader {"
        "  color: #aaaaaa;"
        "  font-size: 11px;"
        "  font-weight: bold;"
        "  padding-top: 2px;"
        "  background: transparent;"
        "}"
        "#SketchPalette #statName {"
        "  color: #999999;"
        "  font-size: 11px;"
        "  background: transparent;"
        "}"
        "#SketchPalette #statValue {"
        "  color: #cccccc;"
        "  font-size: 11px;"
        "  background: transparent;"
        "}"
        "#SketchPalette QCheckBox {"
        "  color: #cccccc;"
        "  spacing: 6px;"
        "  font-size: 11px;"
        "}"
        "#SketchPalette QCheckBox::indicator {"
        "  width: 14px; height: 14px;"
        "  border: 1px solid #555;"
        "  border-radius: 2px;"
        "  background-color: #333;"
        "}"
        "#SketchPalette QCheckBox::indicator:checked {"
        "  background-color: #5294e2;"
        "  border-color: #5294e2;"
        "}"
        "#SketchPalette #finishButton {"
        "  background-color: #5294e2;"
        "  color: #ffffff;"
        "  border: none;"
        "  border-radius: 4px;"
        ...
        "  font-size: 12px;"
        "}"
        "#SketchPalette #finishButton:hover {"
        "  background-color: #6aa5ef;"
        "}"
        "#SketchPalette #finishButton:pressed {"
        "  background-color: #3a7bd5;"
        "}"
        "#SketchPalette QFrame {"
        "  max-height: 1px;"
        "}"
    );
}
