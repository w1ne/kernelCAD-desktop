...
void FeatureDialog::applyStyleSheet()
{
    setStyleSheet(
        ...
        "  border-radius: 6px;"
        "}"
        "#FeatureDialog QLabel {"
        "  color: #cccccc;"
        "  font-size: 11px;"
        "  background: transparent;"
        "}"
        "#FeatureDialog #dialogTitle {"
        "  color: #ffffff;"
        "  font-size: 12px;"
        "  font-weight: bold;"
        "  background: transparent;"
        "}"
        "#FeatureDialog QDoubleSpinBox,"
        "#FeatureDialog QSpinBox,"
        "#FeatureDialog QComboBox {"
        "  background: #3c3f41;"
        "  color: #e0e0e0;"
        "  border: 1px solid #555;"
        "  border-radius: 3px;"
        ...
        "  min-height: 24px;"
        "}"
        "#FeatureDialog QDoubleSpinBox:focus,"
        "#FeatureDialog QSpinBox:focus,"
        "#FeatureDialog QComboBox:focus {"
